...
docker pull byuoitav/rpi-pjlink-service:latest
...
docker run -e PI_TOUCHPANEL="true" -d --restart=always --name pjlink-service -p 8005:8005 byuoitav/rpi-pjlink-service:latest
